...
import {CapaRelatorio, CalculoIGG, FormulaCalculoIGG, InventarioIGG} from "./style"
                ...
                <div>
                  ...
                  <div className="formulas">
                    <ul>
                      ...
                      <li>
                        <h4 className="mb-5">Fórmula Índice de Gravidade Individual (IGI)</h4>
                        <div className="IDGIN flex gap-10">
                            <span className="border-2 border-gray-400">
                                <img className="img-none" src={indiceGravidadeIndividualIMG} alt="" />
                            </span>
                            <span className="border-2 border-gray-400">
